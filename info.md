...
- Set up through UI - no YAML needed!
- Automatic sidebar panel registration

✨ **Theme Integration (v1.1.0)**
- Full Home Assistant theme integration
- Automatic light/dark mode support
- Uses Home Assistant's standard color system
...
5. Search for "Meal Menu" and add it
6. Done! Find "Meal Menu" in your sidebar!
